...
### Pathfinders & Adventurers spotlight

<section class="grid--cards" aria-label="Pathfinders and Adventurers highlights">
  <article class="card card--link">
    <div class="card__body">
      <div>
        <div class="card__title">Pathfinders (ages 10–15)</div>
        <p class="card__desc">
          Outdoor adventures, service projects, and mentoring moments that help teens grow in leadership, faith, and community.
        </p>
      </div>
      <a class="card__cta link" href="/ministries/pathfinders#pathfinders" aria-label="Learn more about Pathfinders">Learn more &rarr;</a>
    </div>
  </article>
